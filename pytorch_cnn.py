...
train_data_loader = torch.utils.data.DataLoader(dataset=train_data, batch_size=128, sampler=sampler, pin_memory=train_on_gpu, num_workers=4)
...
validation_data_loader = torch.utils.data.DataLoader(dataset=train_data, batch_size=128, sampler=sampler, pin_memory=False)#, num_workers=4)
...
class ConvNet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(int(IMG_HEIGHT/4) * int(IMG_WIDTH/4) * 64, 1000)
